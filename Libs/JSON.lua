...
-- Vendored from Gargul (https://github.com/papa-smurf/Gargul, itself
-- vendoring Jeffrey Friedl's JSON.lua per the license above), adapted to a
-- flat global instead of Gargul's own addon-private namespace table.
GuildThing_JSON = {};

local JSON = GuildThing_JSON;
